...
class PICKModel(nn.Module):
    ...
    def make_model(self, embedding_kwargs, encoder_kwargs, graph_kwargs, decoder_kwargs):
        ...
        embedding_kwargs['num_embeddings'] = len(keys_vocab)
        ...
        decoder_kwargs['mlp_kwargs']['out_dim'] = len(iob_labels_vocab)
        decoder_kwargs['crf_kwargs']['num_tags'] = len(iob_labels_vocab)
